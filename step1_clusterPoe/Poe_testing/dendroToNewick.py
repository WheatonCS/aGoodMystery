...
# create and plot dendrograms in two ways:
#  (1) hierarchical dendrogram: sklearn-learn plot() 
#  (2) Newick circular format: ETE (Environment for (phylogenetic) Tree Exploration)
# scottKleinman, mleblanc

import numpy as np
from sklearn.feature_extraction.text import CountVectorizer
from sklearn.metrics.pairwise import euclidean_distances # See line 29
from scipy.spatial.distance import pdist # See line 33
...
## Create linkage matrix. Choose your method (see line 5):
Z = average(Y)
#Z = single(Y)
#Z = weighted(Y)
#Z = complete(Y)
